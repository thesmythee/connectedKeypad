...
#define SET_BIT0(b,v)        SET_BIT(b,v,0x01)
#define SET_BIT1(b,v)        SET_BIT(b,v,0x02)
#define SET_BIT2(b,v)        SET_BIT(b,v,0x04)
#define SET_BIT3(b,v)        SET_BIT(b,v,0x08)
#define SET_BIT4(b,v)        SET_BIT(b,v,0x10)
#define SET_BIT5(b,v)        SET_BIT(b,v,0x20)
#define SET_BIT6(b,v)        SET_BIT(b,v,0x40)
#define SET_BIT7(b,v)        SET_BIT(b,v,0x80)
