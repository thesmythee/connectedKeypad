// file MSGprotocol.h - class describing serial protocol over USB

// if you want to change the format of the messages exchanged with your server via MQTT, update this class
...
{
public:
    MSGprotocol(void) {}                            // Class constructor.  Returns: none
    ...
    void printF7();
    void toneCheck();     // When F7 message has 1, 2, or 3 beeps, don't re-beep at F7 re-issues
...
private:
    ...
    uint8_t parseF7Z(const char * msg, uint8_t len, t_MesgF7 * pMsgF7);
